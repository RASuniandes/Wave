...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Menu.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\User\\Pictures\\OTK\\universidad 2024-1\\RAS\\Ras_UAV\\Wave\\src\\InterfazWave\\img/apps.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
