...
plt.subplot(2, 1, 1)
plt.plot(df['time'], df['yaw'], label='Yaw', color='blue')
plt.xlabel('Time')
...
plt.xlabel('Time')
plt.ylabel('Yaw1 (degrees)')
plt.title('Yaw1 vs Time')
plt.legend()
...
plt.figure(figsize=(10, 6))
plt.subplot(2, 1, 1)
plt.plot(df['time'], df['pitch'], label='Pitch', color='blue')
plt.xlabel('Time')
...
plt.xlabel('Time')
plt.ylabel('Pitch1 (degrees)')
plt.title('Pitch1 vs Time')
plt.legend()
...
plt.figure(figsize=(10, 6))
plt.subplot(2, 1, 1)
plt.plot(df['time'], df['roll'], label='Roll', color='blue')
plt.xlabel('Time')
